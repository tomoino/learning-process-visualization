...
class CoordsVisualizer:
    def __init__(self):
        pass

    def visualize_2d(self, coords: Coords, 
        x_column="dim0", y_column="dim1", label_column="label", colors=["blue", "red"], 
        x_axis_title="dim0", y_axis_title="dim1", x_range=[-10, 10], y_range=[-10, 10], dtick=5):
    ...
    def visualize_3d(
        self, coords: Coords, x_column="dim0", y_column="dim1", z_column="dim2", label_column="label",
        x_axis_title="x", y_axis_title="y", z_axis_title="z", x_range=[-10, 10], y_range=[-10, 10], z_range=[-10, 10], dtick=5
        ):
